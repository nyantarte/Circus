...
public class IOUtils {
    ...
    private static InputStream loadFromStorage(File targetFile)
            throws IOException{
    ...
    public static InputStream getInputStreamFromStorage(String file)
    throws IOException
    {
        return loadFromStorage(new File(Environment.getExternalStorageDirectory().getPath(),file));
    }
